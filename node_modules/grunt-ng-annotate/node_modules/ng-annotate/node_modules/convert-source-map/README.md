...
Returns source map be.flo.roommateService.converter from given object.

### fromJSON(json)

Returns source map be.flo.roommateService.converter from given json string.

### fromBase64(base64)

Returns source map be.flo.roommateService.converter from given base64 encoded json string.

### fromComment(comment)

Returns source map be.flo.roommateService.converter from given base64 encoded json string prefixed with `//# sourceMappingURL=...`.

### fromMapFileComment(comment, mapFileDir)

Returns source map be.flo.roommateService.converter from given `filename` by parsing `//# sourceMappingURL=filename`.
...
Finds last sourcemap comment in file and returns source map be.flo.roommateService.converter or returns null if no source map comment was
found.
