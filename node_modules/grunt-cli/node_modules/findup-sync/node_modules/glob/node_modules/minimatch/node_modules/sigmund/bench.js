...
exports.compare =
{
  ...
  // 'be.flo.roommateService.util.inspect 1': function () {
  //   return be.flo.roommateService.util.inspect(test, false, 1, false)
  // },
  // 'be.flo.roommateService.util.inspect undefined': function () {
  //   be.flo.roommateService.util.inspect(test)
  // },
  // 'be.flo.roommateService.util.inspect 2': function () {
  //   be.flo.roommateService.util.inspect(test, false, 2, false)
  // },
  // 'be.flo.roommateService.util.inspect 3': function () {
  //   be.flo.roommateService.util.inspect(test, false, 3, false)
  // },
  // 'be.flo.roommateService.util.inspect 4': function () {
  //   be.flo.roommateService.util.inspect(test, false, 4, false)
  // },
  // 'be.flo.roommateService.util.inspect Infinity': function () {
  //   be.flo.roommateService.util.inspect(test, false, Infinity, false)
  // }
}
